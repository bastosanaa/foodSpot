...
const colors = {
    ...
    secondary: "#007AFF", // Cor secundária para links e redes sociais
    background: "#121721", // Cor de fundo da página
    textPrimary: "#F2F2F7", // Cor principal do texto
    textSecondary: "#F2F2F7", // Cor secundária do texto
